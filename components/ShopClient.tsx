    ...
    <main>
      ...
      <div style={{ paddingTop: 72, minHeight: '100vh', background: '#faf6f1' }}>
        ...
        <div
          ...
          style={{ background: '#f5efe8', padding: '60px 80px 48px', borderBottom: '1px solid rgba(184,131,111,0.1)' }}
        >
          <div style={{ fontFamily: "'Jost'", fontSize: 11, letterSpacing: '0.35em', color: '#c9a090', textTransform: 'uppercase', marginBottom: 12 }}>ZYRA</div>
          <h1 style={{ fontFamily: "'Cormorant Garamond'", fontSize: 'clamp(36px,5vw,64px)', fontWeight: 300, color: '#3a2a24' }}>Notre Collection</h1>
        ...
        >
            ...
            {CATEGORIES.map((c) => (
              <button
                ...
                style={{
                  ...
                  background: cat === c ? '#b8836f' : 'transparent',
                  color: cat === c ? '#faf6f1' : '#9a7a74',
                  borderBottom: cat === c ? 'none' : '1px solid rgba(154,122,116,0.2)',
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexShrink: 0 }}>
            <span className="hide-mobile" style={{ fontFamily: "'Jost'", fontSize: 11, color: '#9a7a74', letterSpacing: '0.1em' }}>TRIER:</span>
            <select
              value={sort}
              onChange={(e) => setSort(e.target.value)}
              style={{ fontFamily: "'Jost'", fontSize: 11, letterSpacing: '0.1em', background: 'transparent', border: '1px solid rgba(184,131,111,0.2)', padding: '6px 10px', color: '#7a5a54', outline: 'none', cursor: 'pointer' }}
            >
        ...
        {/* Grid */}
        <div className="shop-grid grid-3" style={{ padding: '60px 80px' }}>
