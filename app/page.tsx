...
export default async function Home() {
  ...
  return (
    <main>
      ...
      {/* Best Sellers */}
      <section className="rpad" style={{ background: '#faf6f1' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: 60 }}>
          <SectionHeader eyebrow="Les Plus Aimés" title="Meilleures Ventes" />
          <Link href="/shop" style={{ fontFamily: "'Jost'", fontSize: 11, letterSpacing: '0.15em', textTransform: 'uppercase', color: '#9a7a74', textDecoration: 'none', borderBottom: '1px solid rgba(154,122,116,0.35)', paddingBottom: 2, whiteSpace: 'nowrap', flexShrink: 0 }}>Voir Tout →</Link>
        </div>
      ...
      {/* Editorial banner */}
      <section style={{ position: 'relative', height: '55vh', minHeight: 280, overflow: 'hidden' }}>
        ...
        >
          ...
          <Link
            ...
            style={{ display: 'inline-block', fontFamily: "'Jost'", fontSize: 12, letterSpacing: '0.22em', textTransform: 'uppercase', padding: '16px 44px', background: 'rgba(250,246,241,0.15)', backdropFilter: 'blur(8px)', border: '1px solid rgba(250,246,241,0.3)', color: '#faf6f1', textDecoration: 'none', alignSelf: 'flex-start', cursor: 'pointer' }}
          >
      ...
      {/* New Arrivals */}
      <section className="rpad" style={{ background: '#f5efe8' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: 60 }}>
          <SectionHeader eyebrow="Juste Arrivé" title="Nouveautés" />
          <Link href="/shop" style={{ fontFamily: "'Jost'", fontSize: 11, letterSpacing: '0.15em', textTransform: 'uppercase', color: '#9a7a74', textDecoration: 'none', borderBottom: '1px solid rgba(154,122,116,0.35)', paddingBottom: 2, whiteSpace: 'nowrap', flexShrink: 0 }}>Tout Voir →</Link>
        </div>
        <div className="grid-3">
      ...
      {/* Features strip */}
      <section className="features-strip" style={{ background: '#3a2a24', padding: '60px 80px' }}>
